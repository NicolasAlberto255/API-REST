...
--------------------------------------------------------
  ...
  CREATE TABLE "DEPARTAMENTOS" 
   (	"ID_DEPARTAMENTOS" NUMBER(10,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"NOMBRE_COMUNA_DEPTO" VARCHAR2(50), 
	"NOMBRE_REGION_DEPTO" VARCHAR2(50), 
	"N_BANOS" NUMBER(10,0), 
	"N_DEPTO" NUMBER(10,0), 
...
--------------------------------------------------------
  ...
  "APELLIDO_USUARIO" VARCHAR2(255 CHAR), 
	...
	"REGION_USUARIO" VARCHAR2(255), 
	"COMUNA_USUARIO" VARCHAR2(255),
  "PASSWORD_USUARIO" VARCHAR2(255),
  "ESTADO_USUARIO" VARCHAR2(255)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "COMUNA" MODIFY ("ID_COMUNA");
  ALTER TABLE "COMUNA" MODIFY ("NOMBRE_COMUNA");
  ALTER TABLE "COMUNA" MODIFY ("ID_REGION");
...
--------------------------------------------------------
  ...
  ALTER TABLE "REGION" MODIFY ("ID_REGION");
  ALTER TABLE "REGION" MODIFY ("NOMBRE_REGION");
...
--------------------------------------------------------
  ...
  ALTER TABLE "RESERVA_DEPARTAMENTOS" MODIFY ("DEPARTAMENTOS_ID_RESERVA");
  ALTER TABLE "RESERVA_DEPARTAMENTOS" MODIFY ("DEPARTAMENTOS_ID_DEPARTAMENTOS");
...
--------------------------------------------------------
  ...
  ALTER TABLE "RESERVA_SERVICIOS" MODIFY ("ID_RESERVA");
  ALTER TABLE "RESERVA_SERVICIOS" MODIFY ("ID_SERVICIOS");
...
--------------------------------------------------------
  ...
  ALTER TABLE "RESERVA_USUARIOS" MODIFY ("USUARIOS_ID_RESERVA");
  ALTER TABLE "RESERVA_USUARIOS" MODIFY ("USUARIOS_ID_USUARIO");
