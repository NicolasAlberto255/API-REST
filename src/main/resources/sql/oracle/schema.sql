...
Insert into ADMIN.DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION) values (0,'Casa de Acopio',"Santiago","Puerto Montt","Mas Pruebas",4,10,5,1);
Insert into ADMIN.DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION) values (0,'TEST','Segunda Prueba','Testeo','prueba',4,1234,3,5);
Insert into ADMIN.DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION) values (1,'AAAAA','BBBBBBBBB','CCCCCCCC','DDDDDDDDDD',5,200,1,7);
Insert into ADMIN.DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION) values (1,'Arizona','Maule','Arica','Arica y Parinacota',2,300,8,2);
------------------------------
