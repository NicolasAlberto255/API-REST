...
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Jose','Bote','33.333.333-3','prueba@rent.cl',963214785,'Region Metropolitana','Santiago','pass123',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Pedro','Avion','11.111.111-1','maestro@rent.cl',987412365,'Coquimbo','Coquimbo','password',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Antonio','Automovil','22.222.222-2','testeo@rent.cl',563214789,'Region Metropolitana','Huechuraba','123pass',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Jaime','Carro','88.888.888-8','maspruebas@rent.cl',987654123,'Arica y Parinacota','Arica','456pass',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Pablo','Carruaje','55.555.555-5','otraprueba@rent.cl',123456789,'Valparaíso','Casablanca','pass456',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Javiera','Caballo','44.444.444-4','testing@rent.cl',456123789,'Región del Maule','Constitución','123password',3,'Activo');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO,ID_ROL,ESTADO_USUARIO) values ('Maria','Maletas','77.777.777-7','nunca@rent.cl',456789123,'Región del Biobío','Chiguayante','password124',3,'Activo');
--------------------------------------------------------
