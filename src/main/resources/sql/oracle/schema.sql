...
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS) values ('Ningun Servicio','Nada');
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS) values ('Tour','Servicio que se encarga de entregar Tours en las localidades cercanas');
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS) values ('Taxi','Servicio que se encarga de entregar recorridos con taxis en las localidades cercanas');
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS) values ('Acercamiento','Servicio que se encarga de viajar entre los terminales de buses u aeropuertos hacia el departamento');

Insert into DEPARTAMENTOS (NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION,V_NOCHE,BALCON) values ('Casa de Acopio','Santiago','Region Metropolitana',4,10,5,1,50000,0);
Insert into DEPARTAMENTOS (NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION,V_NOCHE,BALCON) values ('Casa de Oro','Providencia','Region Metropolitana',4,1234,3,5,75000,0);
Insert into DEPARTAMENTOS (NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION,V_NOCHE,BALCON) values ('Casa de Plata','Huechuraba','Region Metropolitana',5,200,1,7,120000,1);
Insert into DEPARTAMENTOS (NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION,V_NOCHE,BALCON) values ('Casa de Piedra','Quilicura','Region Metropolitana',2,300,8,2,100000,1);

Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Jose','Bote','33.333.333-3','prueba@rent.cl','3',963214785,'Region Metropolitana','Santiago','pass123');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Pedro','Avion','11.111.111-1','maestro@rent.cl','3',987412365,'Coquimbo','Coquimbo','password');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Antonio','Automovil','22.222.222-2','testeo@rent.cl','3',563214789,'Region Metropolitana','Huechuraba','123pass');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Jaime','Carro','88.888.888-8','maspruebas@rent.cl','3',987654123,'Arica y Parinacota','Arica','456pass');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Pablo','Carruaje','55.555.555-5','otraprueba@rent.cl','3',123456789,'Valparaíso','Casablanca','pass456');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Javiera','Caballo','44.444.444-4','testing@rent.cl','3',456123789,'Región del Maule','Constitución','123password');
Insert into USUARIO (NOMBRE_USUARIO,APELLIDO_USUARIO,CEDULA_USUARIO,EMAIL_USUARIO,ROL_USUARIO,TELEFONO_USUARIO,REGION_USUARIO,COMUNA_USUARIO,PASSWORD_USUARIO) values ('Maria','Maletas','77.777.777-7','nunca@rent.cl','3',456789123,'Región del Biobío','Chiguayante','password124');
------------------------------
