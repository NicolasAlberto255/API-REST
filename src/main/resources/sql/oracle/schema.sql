...
--------------------------------------------------------
  ...
  CREATE TABLE "DEPARTAMENTOS" 
   (	"ID_DEPARTAMENTOS" NUMBER(10,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"NOMBRE_PROVINCIA_DEPTO" VARCHAR2(50), 
...
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (1,1,'Arica');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (2,1,'Parinacota');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (3,2,'Iquique');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (4,2,'Tamarugal');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (5,3,'Antofagasta');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (6,3,'El Loa');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (7,3,'Tocopilla');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (8,4,'Chañaral');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (9,4,'Copiapó');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (10,4,'Huasco');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (11,5,'Elqui');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (12,5,'Limarí');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (13,5,'Choapa');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (14,6,'Petorca');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (15,6,'Los Andes');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (16,6,'Quillota');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (17,6,'San Antonio');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (18,6,'San Felipe de Aconcagua');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (19,6,'Valparaíso');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (20,6,'Isla de Pascua');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (21,6,'Marga Marga');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (22,7,'Cachapoal');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (23,7,'Cardenal Caro');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (24,7,'Colchagua');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (25,8,'Talca');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (26,8,'Cauquenes');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (27,8,'Curicó');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (28,8,'Linares');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (29,9,'Concepción');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (30,9,'Arauco');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (31,9,'Biobío');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (32,9,'Ñuble');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (33,10,'Cautín');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (34,10,'Malleco');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (35,11,'Valdivia');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (36,11,'Ranco');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (37,12,'Llanquihue');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (38,12,'Chiloé');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (39,12,'Osorno');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (40,12,'Palena');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (41,13,'Coihaique');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (42,13,'Aysén');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (43,13,'Capitán Prat');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (44,13,'General Carrera');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (45,13,'Antártica Chilena');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (46,14,'Magallanes');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (47,14,'Tierra del Fuego');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (48,14,'Última Esperanza');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (49,15,'Santiago');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (50,15,'Cordillera');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (51,15,'Chacabuco');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (52,15,'Maipo');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (53,15,'Melipilla');
Insert into PROVINCIA (ID_PROVINCIA,ID_REGION,NOMBRE_PROVINCIA) values (54,15,'Talagante');
...
Insert into SERVICIOS (DESCRIPCION_SERVICIOS,NOMBRE_SERVICIOS) values ('Servicio que se encarga de entregar Tours en las localidades cercanas','Tour');
Insert into SERVICIOS (DESCRIPCION_SERVICIOS,NOMBRE_SERVICIOS) values ('Servicio que se encarga de entregar recorridos con taxis en las localidades cercanas','Taxi');
Insert into SERVICIOS (DESCRIPCION_SERVICIOS,NOMBRE_SERVICIOS) values ('Servicio que se encarga de viajar entre los terminales de buses u aeropuertos hacia el departamento','Acercamiento');

Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (0,'Casa de Acopio','Santiago','Puerto Montt','Mas Pruebas',4,10,5,1, 50000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (0,'TEST','Segunda Prueba','Testeo','prueba',4,1234,3,5, 75000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (1,'AAAAA','BBBBBBBBB','CCCCCCCC','DDDDDDDDDD',5,200,1,7,120000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_PROVINCIA_DEPTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (1,'Arizona','Arica','Tarapaca','Arica y Parinacota',2,300,8,2, 100000);
------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C009060" ON "PROVINCIA" ("ID_PROVINCIA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROVINCIA" MODIFY ("ID_PROVINCIA");
  ALTER TABLE "PROVINCIA" MODIFY ("ID_REGION");
