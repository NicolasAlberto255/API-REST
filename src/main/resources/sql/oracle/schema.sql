...
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (0,'Casa de Acopio','Santiago','Region Metropolitana',4,10,5,1, 50000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (0,'Casa de Oro','Providencia','Region Metropolitana',4,1234,3,5, 75000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (1,'Casa de Plata','Huechuraba','Region Metropolitana',5,200,1,7,120000);
Insert into DEPARTAMENTOS (BALCON,NOMBRE_DEPARTAMENTO,NOMBRE_COMUNA_DEPTO,NOMBRE_REGION_DEPTO,N_BANOS,N_DEPTO,N_EDIFICIO,N_HABITACION, V_NOCHE) values (1,'Casa de Piedra','Quilicura','Region Metropolitana',2,300,8,2, 100000);
------------------------------
