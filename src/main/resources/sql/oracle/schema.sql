...
--------------------------------------------------------
  ...
  "DESCRIPCION_SERVICIOS" VARCHAR2(255 CHAR), 
	"DISPONIBILIDAD_SERVICIOS" NUMBER(1,0), 
...
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS,DISPONIBILIDAD_SERVICIOS,PRECIO_SERVICIOS) values ('Ningun Servicio','Nada',1,0);
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS,DISPONIBILIDAD_SERVICIOS,PRECIO_SERVICIOS) values ('Tour','Servicio que se encarga de entregar Tours en las localidades cercanas',1,20000);
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS,DISPONIBILIDAD_SERVICIOS,PRECIO_SERVICIOS) values ('Taxi','Servicio que se encarga de entregar recorridos con taxis en las localidades cercanas',1,10000);
Insert into SERVICIOS (NOMBRE_SERVICIOS,DESCRIPCION_SERVICIOS,DISPONIBILIDAD_SERVICIOS,PRECIO_SERVICIOS) values ('Acercamiento','Servicio que se encarga de viajar entre los terminales de buses u aeropuertos hacia el departamento',1,20000);
